...
md = {(i): uniform(0.00002, 0.00006) for i in Plantas for q in Metales for t in Tiempo}
...
cdz = {(i,q): randint(500, 800) for i in Plantas for q in Metales}
cfz = {(i,q): randint(600, 800) for i in Plantas for q in Metales}
